...
<main id="primary" class="site-main" style="background-color:white;">
	...
	<div class="mb-5 container " id="single-blog">
		<div class="d-flex flex-column flex-md-row single-meta align-items-md-center py-2 px-3">

			<div class="d-flex align-items-center ">
				<i class="bi bi-book fs-6 me-2" style="color:#478a0d"></i>
				وبلاگ
			</div>
